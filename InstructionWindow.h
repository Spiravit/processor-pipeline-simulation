...
{
    if (instructionWindow[IF].size() >= 5 || executingBranch)
    {
        return false;
    }
...
bool InstructionWindow::moveIFtoID()
{
    ...
    if (instructionWindow[IF].empty() ||instructionWindow[ID].size() >= 5)
    {
        return false;
    }
...
bool InstructionWindow::moveIDtoEX()
{
    ...
    if (instructionWindow[ID].empty() || instructionWindow[EX].size() >= 5)
    {
        return false;
    }
...
bool InstructionWindow::moveEXtoMEM()
{
    ...
    if (instructionWindow[EX].empty() || instructionWindow[MEM].size() >= 5)
    {
        return false;
    }
...
bool InstructionWindow::moveMEMtoWB()
{
    ...
    if (instructionWindow[MEM].empty() ||instructionWindow[WB].size() >= 5)
    {
        return false;
    }
